...
const FaqItem: React.FC<FaqItemProps> = ({ faq, onView, onRate }) => {
  ...
  return (
    <div className="border-b border-slate-200">
      <button
        className="w-full flex justify-between items-center text-left py-4 px-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
        onClick={toggleOpen}
          ...
          <div className="px-4 pb-4">
              {!rated ? (
                 <div className="flex items-center gap-4 mt-4 p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <p className="text-sm font-medium text-slate-700">Was this answer helpful?</p>
